pipeline {
    ...
    stages {
        stage('Deploy To Kubernetes') {
            steps {
                withKubeCredentials(kubectlCredentials: [[caCertificate: '', clusterName: 'EKS-1', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', serverUrl: 'https://3AD653BCA8155ADA6420AB146EEB63BD.gr7.ap-south-1.eks.amazonaws.com']]) {
